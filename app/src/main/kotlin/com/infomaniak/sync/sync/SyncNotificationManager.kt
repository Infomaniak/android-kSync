...
import com.infomaniak.sync.resource.LocalCollection
import com.infomaniak.sync.resource.LocalContact
import com.infomaniak.sync.resource.LocalEvent
import com.infomaniak.sync.resource.LocalResource
import com.infomaniak.sync.resource.LocalTask
import com.infomaniak.sync.ui.DebugInfoActivity
import com.infomaniak.sync.ui.NotificationRegistry
import com.infomaniak.sync.ui.account.AccountSettingsActivity
...
class SyncNotificationManager @AssistedInject constructor(
    ...
    fun notifyException(
        ...
        contentIntent.data = Uri.parse("sync:exception/${e.hashCode()}")
