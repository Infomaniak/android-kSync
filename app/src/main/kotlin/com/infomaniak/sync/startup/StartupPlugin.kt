...
package com.infomaniak.sync.startup
...
interface StartupPlugin {
    ...
    /**
     * Runs synchronously during [com.infomaniak.sync.App.onCreate]. Use only for tasks that must be completed before
    ...
    /**
     * Runs asynchronously after [com.infomaniak.sync.App.onCreate]. Use for tasks that can be run in the background.
     *
