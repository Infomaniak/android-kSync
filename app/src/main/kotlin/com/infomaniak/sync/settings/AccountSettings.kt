 ...
 */
package com.infomaniak.sync.settings
...
import com.infomaniak.sync.settings.migration.AccountSettingsMigration
...
import com.infomaniak.sync.util.trimToNull
...
class AccountSettings @AssistedInject constructor(
    ...
    init {
        val allowedAccountTypes = arrayOf(
            ...
            "com.infomaniak.sync.test"      // R.strings.account_type_test in androidTest
        )
