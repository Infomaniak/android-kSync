 ...
 */
package com.infomaniak.sync.resource
...
import com.infomaniak.sync.sync.SyncFrameworkIntegration
import com.infomaniak.sync.sync.account.SystemAccountUtils
import com.infomaniak.sync.sync.account.setAndVerifyUserData
...
open class LocalAddressBook @AssistedInject constructor(
    ...
    companion object {
        ...
        /**
         * ID of the corresponding database [com.infomaniak.sync.db.Collection].
         *
